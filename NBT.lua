    ...
    if string.sub(str,1,1) == '[' then
        ...
        while true do
            ...
            elseif string.sub(str, 2, 2) == '"' then
                ...
                if last == nil then last = string.find(input,"]")-1 end
                --if it a number with a postfix
                if tonumber(string.sub(str, 2, last)) == nil then last = last -1 end 
                table.insert(tbl, tonumber(string.sub(str, 2, last)))
            end

            if string.sub(str,last+1,last+1) == ']' then break end
...
--[{id:"minecraft:efficiency",lvl:3s},{id:"minecraft:silk_touch",lvl:5s},{id:"minecraft:fortune",lvl:2s},{id:"minecraft:mending",lvl:2s}]"
--------------------------------------------------
return NBT